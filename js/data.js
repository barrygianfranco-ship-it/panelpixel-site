...
const ARTICLES = [
  ...
  {
    slug: "chi-disegna-davvero-l-intelligenza-artificiale-entra-nel-fumetto-e-nessuno-sa-ancora-dove-fermarla",
    category: "attualita",
    type: "notizia",
    title: "Chi disegna, davvero? L'intelligenza artificiale entra nel fumetto e nessuno sa ancora dove fermarla",
    excerpt: "Tra editori giapponesi che aspettano regole più chiare, copertine Marvel e DC ritirate per sospetto uso di IA, un illustratore coreano riportato in vita da un algoritmo pochi giorni dopo la sua morte: il fumetto sta attraversando la stessa crisi d'identità che ha già toccato la musica e il cinema, solo che qui la posta in gioco è ancora più intima",
    author: "Gianfranco Barry",
    date: "2026-08-07",
    image: "assets/images/kim-jung-gi-copertina.jpg",
    featured: true,
    seoTitle: "Intelligenza artificiale nel fumetto: chi disegna davvero? | Panel Pixel",
    seoDescription: "Dal caso Kim Jung Gi alle copertine Marvel e DC ritirate, il fumetto affronta la stessa crisi d'identità già vissuta da musica e cinema con l'IA generativa.",
    seoKeywords: ["intelligenza artificiale fumetto", "ia generativa comics", "kim jung gi", "manga intelligenza artificiale", "editoria e ia"],
    content: [
      { type: "p", text: "Il 3 ottobre 2022 muore a 47 anni Kim Jung Gi, illustratore coreano considerato da una generazione di disegnatori uno dei più grandi virtuosi del disegno a china a memoria — capace di riempire muri interi di scene affollatissime senza una matita, senza una bozza, senza correzioni. Meno di una settimana dopo la sua morte, uno sviluppatore indipendente francese addestra un modello di intelligenza artificiale sulle sue opere e pubblica online delle immagini \"nel suo stile\", presentandole come un omaggio. La reazione della comunità dei fumettisti è immediata e furiosa. Lo sceneggiatore Dave Scheidt scrive sui social che c'è già \"chi sta replicando il suo stile\" a distanza di giorni dalla sua morte, definendo l'operazione un atto di sciacallaggio. Non è polemica isolata: è l'episodio che, più di ogni discorso teorico, ha reso concreto per il mondo del fumetto cosa significhi davvero l'intelligenza artificiale generativa applicata al disegno. Non uno strumento astratto, ma qualcosa capace di replicare — pochi giorni dopo una morte — un tratto che quella persona aveva costruito in una vita intera.\n\nDa quell'episodio sono passati quattro anni. Il dibattito non si è chiuso: si è solo allargato, complicato, e ha finito per coinvolgere governi, associazioni internazionali, le più grandi case editrici del pianeta e gli stessi autori, che su questo tema non parlano affatto con una voce sola." },
      { type: "image", src: "assets/images/china-a-mano-fumetto-supereroi.jpeg", alt: "Fumettisti disegnano e inchiostrano a mano tavole di supereroi Marvel e DC" },
      { type: "h2", text: "Il caso che ha acceso di nuovo tutto: cosa ha detto davvero un mangaka" },
      { type: "p", text: "Qualche settimana fa un nome molto noto ai lettori di manga più maturi è tornato al centro della discussione. Ospite del programma televisivo giapponese Weekly Ochiai, un autore affermato — celebre per opere dense e visivamente ambiziose, oggi impegnato in un progetto action ambientato in una città ricostruita interamente in tre dimensioni — ha dichiarato che l'uso dell'intelligenza artificiale nei manga \"aumenterebbe enormemente la qualità\" del lavoro, se solo gli editori si decidessero a stabilire regole chiare. La frase, isolata dal contesto, ha fatto il giro dei social nel giro di ore, letta come l'ennesima resa di un autore di peso alla tecnologia.\n\nIl contesto, però, raccontava qualcosa di più articolato. Per la sua opera più recente, l'autore costruisce gli ambienti tridimensionali del manga con Blender e Unreal Engine — gli stessi strumenti usati nell'industria dei videogiochi — modellando lui stesso oltre il novanta per cento degli sfondi prima di trasformarli in tavole disegnate. Un processo lentissimo, che richiede competenze tecniche ben oltre il disegno tradizionale. Quando parla di intelligenza artificiale, parla precisamente di questo: velocizzare la fase di costruzione tridimensionale degli scenari — cartelli stradali, arredi urbani, dettagli di sfondo — non di sostituire il disegno dei personaggi, che nella sua produzione resta interamente manuale. La serie, del resto, è in pausa fino al 2027 anche per via di questa incertezza normativa: gli editori giapponesi, ha spiegato l'autore, non si trovano ancora nella condizione di autorizzare apertamente l'uso di questi strumenti, e lui ha scelto di aspettare regole più chiare piuttosto che muoversi in un vuoto legale e professionale.\n\nPochi giorni dopo, di fronte al fraintendimento dilagato online, lo stesso autore è intervenuto sul proprio profilo social per precisare ulteriormente: l'intelligenza artificiale, quando la utilizza, serve solo a generare dettagli secondari e marginali — poster sullo sfondo, insegne, elementi di contorno — mentre i personaggi restano rigorosamente disegnati a mano, con la cura artigianale che la sua produzione ha sempre avuto.\n\nÈ una posizione più stratificata di quanto i titoli le abbiano concesso di essere. E qui, da chi scrive, va detta una cosa con la massima franchezza: io la penso diversamente, e in modo netto. Non credo che l'intelligenza artificiale generativa possa entrare nel processo creativo di un fumetto — in nessuna fase, nemmeno la più marginale — senza cominciare a intaccarne la natura più profonda. Un tratto, una linea, una scelta compositiva sono il risultato di migliaia di decisioni ripetute nel tempo: anni di allenamento, di tavole buttate, di errori corretti a mano, di uno stile che si forma lentamente per accumulo di fallimenti personali. Delegare anche solo una parte marginale di quel processo a un modello statistico addestrato sul lavoro di altri non è, a mio parere, semplicemente \"velocizzare un mestiere\": è cominciare a smontarlo pezzo per pezzo, normalizzando l'idea che alcune fasi del disegno siano \"meccaniche\" e quindi automatizzabili senza perdita. Ma è un processo cumulativo: quello che oggi è uno sfondo, domani può diventare un'espressione facciale, dopodomani un intero personaggio secondario. La storia della tecnologia applicata all'arte non ha quasi mai conosciuto un punto di equilibrio stabile — solo una progressiva estensione dei confini di ciò che viene considerato accettabile." },
      { type: "image", src: "assets/images/area-pedonale-citta-giapponese.jpg", alt: "Un'area pedonale rialzata in una città giapponese, tra edifici, verde e cartelloni pubblicitari" },
      { type: "h2", text: "Non è un fronte compatto: mangaka contro mangaka" },
      { type: "p", text: "Chi racconta il rapporto tra fumetto giapponese e intelligenza artificiale come uno scontro netto tra \"autori tradizionalisti\" e \"innovatori\" semplifica un quadro molto più frammentato. Il mondo dei mangaka non è una fazione compatta, così come non lo è la comunità dei loro lettori. Ci sono autori che, come l'esempio citato sopra, vedono nell'IA uno strumento paragonabile a quelli che l'industria videoludica usa da vent'anni — utile, se ben regolamentato, a liberare tempo dalle fasi più meccaniche e ripetitive del lavoro. E ci sono autori, editori e soprattutto lettori che considerano qualunque forma di generazione automatica un tradimento del patto implicito tra chi disegna e chi legge: quello per cui dietro ogni tavola c'è una persona che ha scelto, tratto dopo tratto, cosa mettere sulla pagina.\n\nQuesta frattura è emersa con particolare violenza già nel 2022, prima ancora del boom dell'IA generativa mainstream. La startup giapponese Radius5 lanciò in beta un software chiamato Mimic, pensato per permettere agli illustratori di caricare i propri disegni e ottenere in cambio immagini generate nel proprio stile personale — teoricamente uno strumento di supporto, pensato dagli stessi sviluppatori per gli artisti professionisti. I fan giapponesi non la presero affatto bene: si organizzarono per sabotare la beta pubblica inondandola di migliaia di immagini protette da copyright, nel tentativo di comprometterne l'addestramento. Radius5 fu costretta a sospendere i test nel giro di pochi giorni. Fu, per molti osservatori, la prima vittoria organizzata di una comunità di fan contro un software generativo applicato al disegno — ma la battaglia, come si è visto negli anni successivi, era appena cominciata." },
    ],
  },
];
